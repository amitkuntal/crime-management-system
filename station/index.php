...
include_once('navbar.php'); ?>
	...
	<a class="btn btn-primary" href='add_complaints.php'>
	Add complaints
	</a><br><br>
	<a class="btn btn-danger" href='add_missing_person.php'>
	Add Missing Person
	</a></div>
	<div class='col-4 border'>
	<a class="btn btn-danger" href='access_complaints.php'>
	Access Complaints
	</a><br><br>
	<a class="btn btn-primary" href='update_case.php'>
	Update case
	</a></div>
	<div class='col-4 border'>
	<a class='btn btn-primary' href='update_case_progress.php'>
	update Case progress
	</a><br><br>
	<a class="btn btn-danger" href='delete_missing_person.php'>
