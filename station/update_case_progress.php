...
<div class='container'>
			...
			$cid=$_POST['cid'];
			  ...
			  $query=mysql_query("SELECT * FROM complaints where cid='".$cid."'");
						  ...
						  <div class='form-group row '>
							...
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputname' placeholder='' value='{$row['pname']}' name='pname' readonly >
							  <input type='hidden' class='form-control' id='inputname' placeholder='' value='{$row['cid']}' name='cid' readonly >
							</div>
						  </div>
						  <div class='form-group row'>
							<label for='inputPassword3' class='col-sm-4 col-form-label'>Person Mobile no.</label>
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='district' placeholder='' value='{$row['pmob']}' name='pmob' readonly >
							 </div> 
							   
							   <div class='rowspan=4 col-sm-4'>
							  Description<input type='text' class='form-control' id='Description' value='{$row['des']}' name='description' readonly >
						   ...
						   <div class='form-group row'>
							...
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputBlock' placeholder='' value='{$row['pdob']}' name='pdob' readonly >
							</div>
						  </div>
						   <div class='form-group row'>
							<label for='inputIncharge' class='col-sm-4 col-form-label'>Person Address</label>
							<div class='col-sm-4'>
							  <input type='' class='form-control' id='inputIncharge' placeholder='' value='{$row['paddress']}' name='paddress' readonly >
							</div>
						  </div>
						   <div class='form-group row'>
							<label for='inputPassword3' class='col-sm-4 col-form-label'>Person Email ID</label>
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputuser' placeholder='' value='{$row['pemail']}' name='pemail' readonly >
							</div>
						  </div>
						   <div class='form-group row'>
							<label for='inputPassword3' class='col-sm-4 col-form-label'>Accused Person 1 name</label>
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputPassword3' placeholder='' value='{$row['apname1']}' name='apname1' readonly >
							</div>
						  </div>
						  <div class='form-group row'>
							<label for='inputPassword3' class='col-sm-4 col-form-label'>Accused Person 1 info</label>
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputPassword3' placeholder='' value='{$row['apinfo1']}' name='apinfo1' readonly >
							</div>
						  </div>
						  <div class='form-group row'>
							<label for='inputPassword3' class='col-sm-4 col-form-label'>Accused Person 2 name</label>
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputstate' placeholder='' value='{$row['apname2']}' name='apname2' readonly >
							 </div>
								<div class='col-sm-4'>
								  Progress <select class='form-control' name='status'>
						  ...
						  <div class='form-group row'>
							...
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputstate' placeholder='' value='{$row['apinfo2']}' name='apinfo2' readonly >
						  </div>
						  ...
						  <div class='form-group row'>
							...
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputstate' placeholder='' value='{$row['apname3']}' name='apname3' readonly >
							</div>
						  </div>
						  <div class='form-group row'>
							<label for='inputinfo3' class='col-sm-4 col-form-label'>Accused Person 3 info</label>
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputstate' placeholder='' value='{$row['apinfo3']}' name='apinfo3' readonly >
							</div>
						  </div>
						  <div class='form-group row'>
							<label for='inputname4' class='col-sm-4 col-form-label'>Accused Person 4 name</label>
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputstate' placeholder='' value='{$row['apname4']}' name='apname4' readonly >
							</div>
						  </div>
						  ...
						  <div class='form-group row'>
							...
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputstate' placeholder='' value='{$row['apinfo4']}' name='apinfo4' readonly >
							</div>
						  </div>
						  </div>
						  <div class='form-group row'>
							...
							<div class='col-sm-4'>
							  <input type='text' class='form-control' id='inputstate' placeholder='' value='{$row['charges']}' name='charges' readonly >
							</div>
						  </div>
						  
						   <div class='rowspan=4 col-sm-4'>
							  Final Report<input type='text' class='form-control' id='Description'  name='finalreport'>
	...
	if(isset($_POST['update']))
	{
			...
			$finalreport=$_POST['finalreport'];
										...
										`finalreport`='".$finalreport."' WHERE cid='".$cid."'";
